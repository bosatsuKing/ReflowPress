# Architecture and quality diagrams

The diagrams use GitHub-flavored Mermaid and live beside the documentation
...
- [Development and quality loop](../development-loop.md)

The package dependency graph follows current workspace manifests. Planned
conversion stages and future formats are labeled in the graph where they
appear; a diagram is not evidence that a feature has been implemented.
